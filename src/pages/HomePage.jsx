...
const HomePage = () => {
  const blogData = data.map((blogDatas) => {
    ...
    return (
      ...
      >
        ...
        <button className="px-5 py-2 bg-dark-brown text-cream-white rounded-md text-lg items-center">
          <Link to={`/blog/${blogDatas.id}`}>Read more.</Link>
        </button>
      </div>
    );
  });
      ...
      <div className="flex space-x-5">
        ...
        <div className="max-w-64 py-5 px-3 space-y-4 h-4/5">
          <div className="mb-5 border-2 border-dark-brown">
            ...
            />
            <p className="p-1 text-balance text-center">
              Passitionated full-stack web developer and worked some practicle
              applications to solve real time problems .
            </p>
          </div>
          <div className="mb-5 border-2 border-dark-brown flex flex-col">
            <h1 className="bg-dark-brown text-center p-1 text-cream-white ">
              Social Networks
            </h1>
